...
function DashboardIncomeChart() {
  ...
  return (
    ...
    <div className="overflow-x-auto flex flex-col col-span-full sm:col-span-6 relative shadow-lg sm:rounded-lg px-4 mt-6 py-5">
      ...
      <IncomeChart data={chartData} width={595} height={248} />
    </div>
  );
}
